  ...
  return (
    <div className='mt-10 border-t-2'>
      ...
      <div className='flex flex-col lg:flex-row px-10'>
        <div className='grid grid-cols-1 sm:grid-cols-2 w-full lg:w-[50vw] gap-2'>
          <div>
            <img
        ...
        <div className='w-full lg:w-[50vw] flex flex-col justify-center items-start mt-8 sm:mt-0 sm:p-10 gap-10'>
          <div className='text-start'>
            <p className='text-lg'>
              ...
              essentials, premium materials and trims for enhanced durability
              and a stowaway sling strap that transforms the bag into a storage
              kit.
            </p>
          </div>
